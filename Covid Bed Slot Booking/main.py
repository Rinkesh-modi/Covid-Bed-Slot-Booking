import email
import json
from flask import Flask, app, redirect, render_template, flash, request, url_for, session
...
local_server = True
app = Flask(__name__)
app.secret_key = "rinkeshmodi"

# this for getting unique user access
